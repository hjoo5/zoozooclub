...
# Video source
inputFile = loc+'/inputs/334_0402.mp4'
...
#---------------------------------------------
        ...
        for (i, match) in enumerate(blobs):
            ...
            if centroid[0] > 180 and centroid[0] < 630 and centroid[1] < (180/430) * centroid[0] + 85 and centroid[1] > (180/430) * centroid[0] + 55:
                cv2.rectangle(frame, (x, y), (x + w - 1, y + h - 1),
                              (0, 255, 0), CAR_LINE_THICKNESS)
                # 자동차 이동 추적하는 원
